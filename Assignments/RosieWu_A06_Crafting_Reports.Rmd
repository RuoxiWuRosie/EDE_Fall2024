...
```{r, echo=FALSE, warning = FALSE, message = FALSE, fig.cap="Distribution of Ozone Levels by Month 2018", fig.height=4,fig.width=6}
...
```{r, echo=FALSE, warning = FALSE, message = FALSE, fig.cap="Distribution of Ozone Levels by Month 2019", fig.height=4,fig.width=6}
