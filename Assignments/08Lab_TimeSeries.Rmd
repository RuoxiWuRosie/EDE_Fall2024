...
BR_complete_Temp_ts <- ts(BR_complete$Temperature_C, start = c(f_year,f_month), frequency = 12)
...
Rainfall_ts_Decomposed <- stl(BR_complete_Rainfall_ts, s.window = "periodic")
Temp_ts_Decomposed <- stl(BR_complete_Temp_ts, s.window = "periodic")
...
BR_rain_components <- 
  as.data.frame(Rainfall_ts_Decomposed$time.series[,1:3])
