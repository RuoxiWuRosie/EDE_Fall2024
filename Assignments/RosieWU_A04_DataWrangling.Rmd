...
write.csv(reshaped_set, file.path(target_directory, "EPAair_O3_PM25_NC1819_Processed.csv"), row.names = FALSE)
...
#12 summary datset: Data should be grouped by site, month, and year
