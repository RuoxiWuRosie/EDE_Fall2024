...
EPAO3_2018_q4 <- EPAO3_2018[c("Date", "DAILY_AQI_VALUE", "Site.Name", 
            "AQS_PARAMETER_DESC", "COUNTY", "SITE_LATITUDE", "SITE_LONGITUDE")]
EPAO3_2019_q4 <- EPAO3_2019[c("Date", "DAILY_AQI_VALUE", "Site.Name", 
            "AQS_PARAMETER_DESC", "COUNTY", "SITE_LATITUDE", "SITE_LONGITUDE")]
...
write.csv(EPAO3_2018_q4, file.path(target_directory, 
                          "EPAair_O3_NC2018_processed.csv"), row.names = FALSE)
write.csv(EPAO3_2019_q4, file.path(target_directory, 
...
combined_set = rbind(EPAO3_2018_q4, EPAO3_2019_q4, EPAPM25_2018_q4, 
                     EPAPM25_2019_q4)
