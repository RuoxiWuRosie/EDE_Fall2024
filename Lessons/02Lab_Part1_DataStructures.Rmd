...
temps_F <- c(80,81,78,74,73)

#What is the average of these temperatures 
ave_temps_F <- mean(temps_F)
...
matrix1[4,  ] # row 4, all values

matrix1[ , 3] # column 3 values

matrix1[c(12, 14)] # row 12, 14

matrix1[c(12:14)] # row 12-14

matrix1[2:4, 1:3] # values in row 2-4, and columns 1-3.
