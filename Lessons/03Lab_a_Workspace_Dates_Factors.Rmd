...
NTL-LTER_Lake_ChemistryPhysics <- read.csv(
...
```{r DateExercise1}
# install commands have to be commented out to be able to be knitted
...
ggplot(usgs_flow_data,aes(x=month)) + geom_bar() + scale_x_discrete(drop=FALSE)
